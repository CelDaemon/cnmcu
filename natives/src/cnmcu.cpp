...
void init(JavaVM* vm)
{
    ...
    jclass Common;
    jfieldID Common_LOGGER_id;

    // Common.LOGGER
    GET_CLASS(Common, "com/elmfer/cnmcu/common/Common");
    GET_STATIC_FIELD_ID(Common_LOGGER_id, Common, "LOGGER", "Lorg/slf4j/Logger;");
    LOGGER = env->GetStaticObjectField(Common, Common_LOGGER_id);
